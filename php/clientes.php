                ...
                <div class="col-12">
                    <div class="card border-dark mb-3 text-left">
                        <div class="card-body d-flex justify-content-between client">
                            ...
                            <div>
                                <button class="btn btn-outline-secondary " v-on:click="eliminar(cliente.dni)"><i class="far fa-trash-alt"></i></button>
                        ...
                        <div class="card-footer bg-transparent border-dark d-flex justify-content-between">
                            <a data-toggle="modal" data-target="#tratamientos" href="#" v-on:click="mostrarTratamientos(cliente.dni)"><small id="info" class="form-text text-muted">Tratamientos</small></a>
                            <button class="btn btn-outline-secondary">Añadir tratamiento</button>
